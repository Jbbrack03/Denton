# Supported Games for Sudachi Multiplayer
...
| Minecraft | ⚠️ | 2-8 | World sync issues occasionally |
...
For fighting games and competitive titles, use these recommended settings:
